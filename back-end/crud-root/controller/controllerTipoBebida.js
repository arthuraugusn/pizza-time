...
- OBJETIVO: Arquivo responsável pela manipulação de recebimento, tratamento e retorno de dados entre a API e a model de tipos de bebidas
...
const listarTiposBebidas = async function(){
    ...
    const{selectAllTiposBebidas} = require('../model/dao/tipo_bebida.js')
...
const novoTipoBebida = async function(nomeTipo){
    if(nomeTipo =='' || nomeTipo == undefined){
        ...
        const novoTipo = require('../model/dao/tipo_bebida.js')
...
const deletarTipoBebida = async function(idTipo){
    if(idTipo == '' || idTipo == undefined){
        ...
        const deletarTipo= require('../model/dao/tipo_bebida.js')
...
const buscaTipoIdBebida = async function(idTipo){
    ...
    if(idTipo == '' || idTipo == undefined){
        ...
        const {selectByIdTipoBebida} = require('../model/dao/tipo_bebida.js')
...
const atualizarTipoBebida = async function(tipoBebida){
    if(tipoBebida.id == '' || tipoBebida.id == undefined){
        ...
        const atualizarTipo = require('../model/dao/tipo_bebida.js')
